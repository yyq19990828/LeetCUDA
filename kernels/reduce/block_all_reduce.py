...
for S, K in SKs:
    ...
    run_benchmark(
        lib.block_all_reduce_sum_fp8_e4m3x16_pack_f16, values_f8e4m3, "f8e4m3x16packf16"
    )
    run_benchmark(
    ...
    run_benchmark(
        lib.block_all_reduce_sum_fp8_e5m2x16_pack_f16, values_f8e5m2, "f8e5m2x16packf16"
    )
    run_benchmark(
